...
- [常用的并发基础构建模块](#%E5%B8%B8%E7%94%A8%E7%9A%84%E5%B9%B6%E5%8F%91%E5%9F%BA%E7%A1%80%E6%9E%84%E5%BB%BA%E6%A8%A1%E5%9D%97)
  ...
  - [并发容器类](#%E5%B9%B6%E5%8F%91%E5%AE%B9%E5%99%A8%E7%B1%BB)
    - [ConcurrentHashMap](#concurrenthashmap)
      - [HashMap 和 HashTable 的缺点](#hashmap-%E5%92%8C-hashtable-%E7%9A%84%E7%BC%BA%E7%82%B9)
      - [特点](#%E7%89%B9%E7%82%B9)
      - [锁分段实现原理](#%E9%94%81%E5%88%86%E6%AE%B5%E5%AE%9E%E7%8E%B0%E5%8E%9F%E7%90%86)
      - [关于put操作需要注意的点](#%E5%85%B3%E4%BA%8Eput%E6%93%8D%E4%BD%9C%E9%9C%80%E8%A6%81%E6%B3%A8%E6%84%8F%E7%9A%84%E7%82%B9)
...
#### HashMap 和 HashTable 的缺点

**HashMap**
- HashMap不是线程安全的，在并发执行put(K, V)操作时会引起死循环

*源码解释：*

HashMap中，put(K, V)操作是调用putVal完成的：

```java
transient Node<K,V>[] table;  // 通过hash & (n-1)来找到对应Node存储的位置
...
当Map的table容量超标时，`putVal`方法会调用`resize()`方法对Map进行扩容，在`resize`的过程中，我们要进行rehash，在扩容的`resize`方法中有这样一段代码：
...
- 是否需要扩容
  - 在插入元素前判断是否需要扩容，
  - 比HashMap的插入元素后判断是否需要扩容要好，因为可以插入元素后，Map扩容，之后不再有新的元素插入，Map就进行了一次无效的扩容
- 如何扩容
